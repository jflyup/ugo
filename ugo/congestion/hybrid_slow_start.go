...
// tcp_cubic.c.
const hybridStartLowWindow = uint32(16)
...
func (s *HybridSlowStart) ShouldExitSlowStart(latestRTT time.Duration, minRTT time.Duration, congestionWindow uint32) bool {
	if !s.started {
